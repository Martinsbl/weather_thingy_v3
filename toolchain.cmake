...
SET(LINKER_SCRIPT "/home/martin/Nordic/SDK11/examples/weather_thingy/ble_weather_thingy/linker.ld")
SET(TEMPLATE_PATH "/home/martin/Nordic/SDK11/components/toolchain/gcc/Makefile.windows")
SET(CMAKE_EXE_LINKER_FLAGS "-Xlinker -Map=${OUTPUT_FILENAME}.map -mthumb -mabi=aapcs -L ${TEMPLATE_PATH} -T${LINKER_SCRIPT} -mcpu=cortex-m0 -Wl,--gc-sections  --specs=nano.specs -lc -lnosys")
